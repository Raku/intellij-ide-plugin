...
public class Perl6CommunityCroRunConfigurationType extends ConfigurationTypeBase {
    ...
    @NotNull
    public static Perl6CommunityCroRunConfigurationType getInstance() {
        return CONFIGURATION_TYPE_EP.findExtension(Perl6CommunityCroRunConfigurationType.class);
    }
