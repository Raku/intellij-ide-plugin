...
public class MAINBraid extends Cursor<MAINBraid> {
    ...
    public int runRule() {
        ...
        case 137:
            ...
            break;
        case 138:
            result = this._138_EXPR();
            break;
        case 139:
            result = this._139_prefixish();
            break;
        case 140:
            result = this._140_prefix();
            break;
        case 141:
            result = this._141_postfixish();
            break;
        case 142:
            result = this._142_postfix();
            break;
        case 143:
            result = this._143_dotty();
            break;
        case 144:
            result = this._144_dottyop();
            break;
        case 145:
            result = this._145_privop();
            break;
        case 146:
            result = this._146_methodop();
            break;
        case 147:
            result = this._147_postcircumfix();
            break;
        case 148:
            result = this._148_infixish();
            break;
        case 149:
            result = this._149_infixstopper();
            break;
        case 150:
            result = this._150_infix();
            break;
        case 151:
            result = this._151_termish();
            break;
        case 152:
            result = this._152_enter_regex_nibblier();
            break;
        case 153:
            result = this._153_regex_nibbler();
            break;
        case 154:
            result = this._154_rxstopper();
            break;
        case 155:
            result = this._155_rxinfixstopper();
            break;
        case 156:
            result = this._156_termseq();
            break;
        case 157:
            result = this._157_termaltseq();
            break;
        case 158:
            result = this._158_termconjseq();
            break;
        case 159:
            result = this._159_termalt();
            break;
        case 160:
            result = this._160_termconj();
            break;
        case 161:
            result = this._161_rxtermish();
            break;
        case 162:
            result = this._162_SIGOK();
            break;
        case 163:
            result = this._163_sigmaybe();
            break;
        case 164:
            result = this._164_normspace();
            break;
        case 165:
            result = this._165_quantified_atom();
            break;
        case 166:
            result = this._166_separator();
            break;
        case 167:
            result = this._167_atom();
            break;
        case 168:
            result = this._168_quantifier();
            break;
        case 169:
            result = this._169_rxcodeblock();
            break;
        case 170:
            result = this._170_backmod();
            break;
        case 171:
            result = this._171_metachar();
            break;
        case 172:
            result = this._172_rxq();
            break;
        case 173:
            result = this._173_rxqq();
            break;
        case 174:
            result = this._174_rxqw();
            break;
        case 175:
            result = this._175_backslash();
            break;
        case 176:
            result = this._176_assertion();
            break;
        case 177:
            result = this._177_rxarglist();
            break;
        case 178:
            result = this._178_cclass_elem();
            break;
        case 179:
            result = this._179_cclass_backslash();
            break;
        case 180:
    ...
    private int _147_postcircumfix() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _152_enter_regex_nibblier() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(2);
    ...
    private int _153_regex_nibbler() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _155_rxinfixstopper() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _165_quantified_atom() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _179_cclass_backslash() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
