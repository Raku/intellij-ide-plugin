...
public class MAINBraid extends Cursor<MAINBraid> {
    ...
    public int runRule() {
        ...
        case 137:
            ...
            break;
        case 138:
            result = this._138_methodop();
            break;
        case 139:
            result = this._139_postcircumfix();
            break;
        case 140:
            result = this._140_infixish();
            break;
        case 141:
            result = this._141_infixstopper();
            break;
        case 142:
            result = this._142_infix();
            break;
        case 143:
            result = this._143_termish();
            break;
        case 144:
    ...
    private int _139_postcircumfix() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
