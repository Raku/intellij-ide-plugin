...
public class MAINBraid extends Cursor<MAINBraid> {
    ...
    public int runRule() {
        ...
        case 132:
            ...
            break;
        case 133:
            result = this._133_rat_number();
            break;
        case 134:
            result = this._134_bare_rat_number();
            break;
        case 135:
            result = this._135_complex_number();
            break;
        case 136:
            result = this._136_bare_complex_number();
            break;
        case 137:
            result = this._137_signed_number();
            break;
        case 138:
            result = this._138_rad_number();
            break;
        case 139:
            result = this._139_rad_digits();
            break;
        case 140:
            result = this._140_rad_digit();
            break;
        case 141:
            result = this._141_radint();
            break;
        case 142:
            result = this._142_integer();
            break;
        case 143:
            result = this._143_signed_integer();
            break;
        case 144:
            result = this._144_integer_lex();
            break;
        case 145:
            result = this._145_decint();
            break;
        case 146:
            result = this._146_hexint();
            break;
        case 147:
            result = this._147_octint();
            break;
        case 148:
            result = this._148_binint();
            break;
        case 149:
            result = this._149_charname();
            break;
        case 150:
            result = this._150_hexints();
            break;
        case 151:
            result = this._151_octints();
            break;
        case 152:
            result = this._152_charnames();
            break;
        case 153:
            result = this._153_charspec();
            break;
        case 154:
            result = this._154_typename();
            break;
        case 155:
            result = this._155_quote();
            break;
        case 156:
            result = this._156_quote_Q();
            break;
        case 157:
            result = this._157_quote_q();
            break;
        case 158:
            result = this._158_quote_qq();
            break;
        case 159:
            result = this._159_quote_nibbler();
            break;
        case 160:
            result = this._160_starter();
            break;
        case 161:
            result = this._161_stopper();
            break;
        case 162:
            result = this._162_quote_escape();
            break;
        case 163:
            result = this._163_circumfix();
            break;
        case 164:
            result = this._164_EXPR();
            break;
        case 165:
            result = this._165_prefixish();
            break;
        case 166:
            result = this._166_prefix();
            break;
        case 167:
            result = this._167_postfixish();
            break;
        case 168:
            result = this._168_postfix();
            break;
        case 169:
            result = this._169_dotty();
            break;
        case 170:
            result = this._170_dottyop();
            break;
        case 171:
            result = this._171_privop();
            break;
        case 172:
            result = this._172_methodop();
            break;
        case 173:
            result = this._173_postcircumfix();
            break;
        case 174:
            result = this._174_infixish();
            break;
        case 175:
            result = this._175_infixstopper();
            break;
        case 176:
            result = this._176_infix();
            break;
        case 177:
            result = this._177_termish();
            break;
        case 178:
            result = this._178_enter_regex_nibblier();
            break;
        case 179:
            result = this._179_regex_nibbler();
            break;
        case 180:
            result = this._180_rxstopper();
            break;
        case 181:
            result = this._181_rxinfixstopper();
            break;
        case 182:
            result = this._182_termseq();
            break;
        case 183:
            result = this._183_termaltseq();
            break;
        case 184:
            result = this._184_termconjseq();
            break;
        case 185:
            result = this._185_termalt();
            break;
        case 186:
            result = this._186_termconj();
            break;
        case 187:
            result = this._187_rxtermish();
            break;
        case 188:
            result = this._188_SIGOK();
            break;
        case 189:
            result = this._189_sigmaybe();
            break;
        case 190:
            result = this._190_normspace();
            break;
        case 191:
            result = this._191_quantified_atom();
            break;
        case 192:
            result = this._192_separator();
            break;
        case 193:
            result = this._193_atom();
            break;
        case 194:
            result = this._194_quantifier();
            break;
        case 195:
            result = this._195_rxcodeblock();
            break;
        case 196:
            result = this._196_backmod();
            break;
        case 197:
            result = this._197_metachar();
            break;
        case 198:
            result = this._198_rxq();
            break;
        case 199:
            result = this._199_rxqq();
            break;
        case 200:
            result = this._200_rxqw();
            break;
        case 201:
            result = this._201_backslash();
            break;
        case 202:
            result = this._202_assertion();
            break;
        case 203:
            result = this._203_rxarglist();
            break;
        case 204:
            result = this._204_cclass_elem();
            break;
        case 205:
            result = this._205_cclass_backslash();
            break;
        case 206:
    ...
    private int _98_scope_declarator() {
        ...
        while (true) {
            ...
            case 26:
                this.startToken(Perl6TokenTypes.INCOMPLETE_SCOPED_DECLARATION);
                this.state = 27;
                return -3;
    ...
    private int _99_declarator() {
        ...
        while (true) {
            ...
            case 0:
                ...
                this.startToken(Perl6TokenTypes.TERM_DECLARATION_BACKSLASH);
                if (!(this.literal("\\"))) {
                    if (this.backtrack()) {
                        continue;
                    } else {
    ...
    private int _101_variable_declarator() {
        ...
        while (true) {
            ...
            case 6:
                this.bsFailMark(18);
                this.bsMark(12);
                this.startToken(Perl6TokenTypes.SHAPE_DECLARATION);
                if (!(this.literal("["))) {
                    if (this.backtrack()) {
                        continue;
                    } else {
    ...
    private int _134_bare_rat_number() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _135_complex_number() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
                ...
                this.startToken(Perl6TokenTypes.COMPLEX_LITERAL);
                if (!(this.literal("<"))) {
                    if (this.backtrack()) {
                        continue;
                    } else {
    ...
    private int _136_bare_complex_number() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _137_signed_number() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _138_rad_number() {
        ...
        while (true) {
            ...
            case 0:
                ...
                this.startToken(Perl6TokenTypes.RADIX_NUMBER);
                if (!(this.literal(":"))) {
                    if (this.backtrack()) {
                        continue;
                    } else {
    ...
    private int _140_rad_digit() {
        while (true) {
            ...
            case 1:
                if (!(this.inCharList("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ\uFF41\uFF42\uFF43\uFF44\uFF45\uFF46\uFF47\uFF48\uFF49\uFF4A\uFF4B\uFF4C\uFF4D\uFF4E\uFF4F\uFF50\uFF51\uFF52\uFF53\uFF54\uFF55\uFF56\uFF57\uFF58\uFF59\uFF5A\uFF21\uFF22\uFF23\uFF24\uFF25\uFF26\uFF27\uFF28\uFF29\uFF2A\uFF2B\uFF2C\uFF2D\uFF2E\uFF2F\uFF30\uFF31\uFF32\uFF33\uFF34\uFF35\uFF36\uFF37\uFF38\uFF39\uFF3A"))) {
                    if (this.backtrack()) {
                        continue;
                    } else {
                        return -2;
    ...
    private int _143_signed_integer() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _159_quote_nibbler() {
        int rep;
        while (true) {
            switch (this.state) {
            case 0:
    ...
    private int _173_postcircumfix() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _178_enter_regex_nibblier() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(2);
    ...
    private int _179_regex_nibbler() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _181_rxinfixstopper() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _191_quantified_atom() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _205_cclass_backslash() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
