...
public class MAINBraid extends Cursor<MAINBraid> {
    ...
    public int runRule() {
        ...
        case 40:
            ...
            break;
        case 41:
            result = this._41_statement_control_CATCH();
            break;
        case 42:
            result = this._42_statement_control_CONTROL();
            break;
        case 43:
            result = this._43_statement_control_QUIT();
            break;
        case 44:
            result = this._44_statement_prefix();
            break;
        case 45:
            result = this._45_phaser_name();
            break;
        case 46:
            result = this._46_statement_prefix_phaser();
            break;
        case 47:
            result = this._47_blorst();
            break;
        case 48:
            result = this._48_statement_mod_cond_keyword();
            break;
        case 49:
            result = this._49_statement_mod_cond();
            break;
        case 50:
            result = this._50_statement_mod_loop_keyword();
            break;
        case 51:
            result = this._51_statement_mod_loop();
            break;
        case 52:
            result = this._52_term();
            break;
        case 53:
            result = this._53_term_ident();
            break;
        case 54:
            result = this._54_term_name();
            break;
        case 55:
            result = this._55_term_whatever();
            break;
        case 56:
            result = this._56_term_hyperwhatever();
            break;
        case 57:
            result = this._57_args();
            break;
        case 58:
            result = this._58_semiarglist();
            break;
        case 59:
            result = this._59_arglist();
            break;
        case 60:
            result = this._60_variable();
            break;
        case 61:
            result = this._61_scope_declarator();
            break;
        case 62:
            result = this._62_declarator();
            break;
        case 63:
            result = this._63_multi_declarator();
            break;
        case 64:
            result = this._64_variable_declarator();
            break;
        case 65:
            result = this._65_routine_declarator();
            break;
        case 66:
            result = this._66_routine_def();
            break;
        case 67:
            result = this._67_onlystar();
            break;
        case 68:
            result = this._68_initializer();
            break;
        case 69:
            result = this._69_sigil();
            break;
        case 70:
            result = this._70_twigil();
            break;
        case 71:
            result = this._71_desigilname();
            break;
        case 72:
            result = this._72_value();
            break;
        case 73:
            result = this._73_number();
            break;
        case 74:
            result = this._74_numish();
            break;
        case 75:
            result = this._75_dec_number();
            break;
        case 76:
            result = this._76_escale();
            break;
        case 77:
            result = this._77_sign();
            break;
        case 78:
            result = this._78_integer();
            break;
        case 79:
            result = this._79_integer_lex();
            break;
        case 80:
            result = this._80_decint();
            break;
        case 81:
            result = this._81_hexint();
            break;
        case 82:
            result = this._82_octint();
            break;
        case 83:
            result = this._83_binint();
            break;
        case 84:
            result = this._84_charname();
            break;
        case 85:
            result = this._85_hexints();
            break;
        case 86:
            result = this._86_octints();
            break;
        case 87:
            result = this._87_charnames();
            break;
        case 88:
            result = this._88_charspec();
            break;
        case 89:
            result = this._89_quote();
            break;
        case 90:
            result = this._90_quote_Q();
            break;
        case 91:
            result = this._91_quote_q();
            break;
        case 92:
            result = this._92_quote_qq();
            break;
        case 93:
            result = this._93_quote_nibbler();
            break;
        case 94:
            result = this._94_starter();
            break;
        case 95:
            result = this._95_stopper();
            break;
        case 96:
            result = this._96_quote_escape();
            break;
        case 97:
            result = this._97_EXPR();
            break;
        case 98:
            result = this._98_prefixish();
            break;
        case 99:
            result = this._99_prefix();
            break;
        case 100:
            result = this._100_postfixish();
            break;
        case 101:
            result = this._101_postfix();
            break;
        case 102:
            result = this._102_dotty();
            break;
        case 103:
            result = this._103_dottyop();
            break;
        case 104:
            result = this._104_methodop();
            break;
        case 105:
            result = this._105_infixish();
            break;
        case 106:
            result = this._106_infixstopper();
            break;
        case 107:
            result = this._107_infix();
            break;
        case 108:
            result = this._108_termish();
            break;
        case 109:
    ...
    private int _41_statement_control_CATCH() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _42_statement_control_CONTROL() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _43_statement_control_QUIT() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _44_statement_prefix() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _46_statement_prefix_phaser() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _48_statement_mod_cond_keyword() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _49_statement_mod_cond() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _50_statement_mod_loop_keyword() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _51_statement_mod_loop() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _56_term_hyperwhatever() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _61_scope_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _63_multi_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _64_variable_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _65_routine_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
