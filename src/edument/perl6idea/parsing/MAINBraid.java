...
public class MAINBraid extends Cursor<MAINBraid> {
    ...
    public int runRule() {
        ...
        case 26:
            ...
            break;
        case 27:
            result = this._27_statement_control_while();
            break;
        case 28:
            result = this._28_statement_control_until();
            break;
        case 29:
            result = this._29_statement_control_for();
            break;
        case 30:
            result = this._30_statement_control_use();
            break;
        case 31:
            result = this._31_term();
            break;
        case 32:
            result = this._32_term_ident();
            break;
        case 33:
            result = this._33_term_name();
            break;
        case 34:
            result = this._34_term_whatever();
            break;
        case 35:
            result = this._35_term_hyperwhatever();
            break;
        case 36:
            result = this._36_args();
            break;
        case 37:
            result = this._37_semiarglist();
            break;
        case 38:
            result = this._38_arglist();
            break;
        case 39:
            result = this._39_variable();
            break;
        case 40:
            result = this._40_scope_declarator();
            break;
        case 41:
            result = this._41_declarator();
            break;
        case 42:
            result = this._42_multi_declarator();
            break;
        case 43:
            result = this._43_variable_declarator();
            break;
        case 44:
            result = this._44_routine_declarator();
            break;
        case 45:
            result = this._45_routine_def();
            break;
        case 46:
            result = this._46_onlystar();
            break;
        case 47:
            result = this._47_initializer();
            break;
        case 48:
            result = this._48_sigil();
            break;
        case 49:
            result = this._49_twigil();
            break;
        case 50:
            result = this._50_desigilname();
            break;
        case 51:
            result = this._51_value();
            break;
        case 52:
            result = this._52_number();
            break;
        case 53:
            result = this._53_numish();
            break;
        case 54:
            result = this._54_dec_number();
            break;
        case 55:
            result = this._55_escale();
            break;
        case 56:
            result = this._56_sign();
            break;
        case 57:
            result = this._57_integer();
            break;
        case 58:
            result = this._58_integer_lex();
            break;
        case 59:
            result = this._59_decint();
            break;
        case 60:
            result = this._60_hexint();
            break;
        case 61:
            result = this._61_octint();
            break;
        case 62:
            result = this._62_binint();
            break;
        case 63:
            result = this._63_charname();
            break;
        case 64:
            result = this._64_hexints();
            break;
        case 65:
            result = this._65_octints();
            break;
        case 66:
            result = this._66_charnames();
            break;
        case 67:
            result = this._67_charspec();
            break;
        case 68:
            result = this._68_quote();
            break;
        case 69:
            result = this._69_quote_Q();
            break;
        case 70:
            result = this._70_quote_q();
            break;
        case 71:
            result = this._71_quote_qq();
            break;
        case 72:
            result = this._72_quote_nibbler();
            break;
        case 73:
            result = this._73_starter();
            break;
        case 74:
            result = this._74_stopper();
            break;
        case 75:
            result = this._75_quote_escape();
            break;
        case 76:
            result = this._76_EXPR();
            break;
        case 77:
            result = this._77_prefixish();
            break;
        case 78:
            result = this._78_prefix();
            break;
        case 79:
            result = this._79_postfixish();
            break;
        case 80:
            result = this._80_postfix();
            break;
        case 81:
            result = this._81_dotty();
            break;
        case 82:
            result = this._82_dottyop();
            break;
        case 83:
            result = this._83_methodop();
            break;
        case 84:
            result = this._84_infixish();
            break;
        case 85:
            result = this._85_infixstopper();
            break;
        case 86:
            result = this._86_infix();
            break;
        case 87:
            result = this._87_termish();
            break;
        case 88:
    ...
    private int _27_statement_control_while() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _28_statement_control_until() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _29_statement_control_for() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _30_statement_control_use() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _35_term_hyperwhatever() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _40_scope_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _42_multi_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _43_variable_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _44_routine_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
