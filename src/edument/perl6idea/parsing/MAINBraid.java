...
public class MAINBraid extends Cursor<MAINBraid> {
    ...
    public int runRule() {
        ...
        case 31:
            ...
            break;
        case 32:
            result = this._32_statement_control_use();
            break;
        case 33:
            result = this._33_term();
            break;
        case 34:
            result = this._34_term_ident();
            break;
        case 35:
            result = this._35_term_name();
            break;
        case 36:
            result = this._36_term_whatever();
            break;
        case 37:
            result = this._37_term_hyperwhatever();
            break;
        case 38:
            result = this._38_args();
            break;
        case 39:
            result = this._39_semiarglist();
            break;
        case 40:
            result = this._40_arglist();
            break;
        case 41:
            result = this._41_variable();
            break;
        case 42:
            result = this._42_scope_declarator();
            break;
        case 43:
            result = this._43_declarator();
            break;
        case 44:
            result = this._44_multi_declarator();
            break;
        case 45:
            result = this._45_variable_declarator();
            break;
        case 46:
            result = this._46_routine_declarator();
            break;
        case 47:
            result = this._47_routine_def();
            break;
        case 48:
            result = this._48_onlystar();
            break;
        case 49:
            result = this._49_initializer();
            break;
        case 50:
            result = this._50_sigil();
            break;
        case 51:
            result = this._51_twigil();
            break;
        case 52:
            result = this._52_desigilname();
            break;
        case 53:
            result = this._53_value();
            break;
        case 54:
            result = this._54_number();
            break;
        case 55:
            result = this._55_numish();
            break;
        case 56:
            result = this._56_dec_number();
            break;
        case 57:
            result = this._57_escale();
            break;
        case 58:
            result = this._58_sign();
            break;
        case 59:
            result = this._59_integer();
            break;
        case 60:
            result = this._60_integer_lex();
            break;
        case 61:
            result = this._61_decint();
            break;
        case 62:
            result = this._62_hexint();
            break;
        case 63:
            result = this._63_octint();
            break;
        case 64:
            result = this._64_binint();
            break;
        case 65:
            result = this._65_charname();
            break;
        case 66:
            result = this._66_hexints();
            break;
        case 67:
            result = this._67_octints();
            break;
        case 68:
            result = this._68_charnames();
            break;
        case 69:
            result = this._69_charspec();
            break;
        case 70:
            result = this._70_quote();
            break;
        case 71:
            result = this._71_quote_Q();
            break;
        case 72:
            result = this._72_quote_q();
            break;
        case 73:
            result = this._73_quote_qq();
            break;
        case 74:
            result = this._74_quote_nibbler();
            break;
        case 75:
            result = this._75_starter();
            break;
        case 76:
            result = this._76_stopper();
            break;
        case 77:
            result = this._77_quote_escape();
            break;
        case 78:
            result = this._78_EXPR();
            break;
        case 79:
            result = this._79_prefixish();
            break;
        case 80:
            result = this._80_prefix();
            break;
        case 81:
            result = this._81_postfixish();
            break;
        case 82:
            result = this._82_postfix();
            break;
        case 83:
            result = this._83_dotty();
            break;
        case 84:
            result = this._84_dottyop();
            break;
        case 85:
            result = this._85_methodop();
            break;
        case 86:
            result = this._86_infixish();
            break;
        case 87:
            result = this._87_infixstopper();
            break;
        case 88:
            result = this._88_infix();
            break;
        case 89:
            result = this._89_termish();
            break;
        case 90:
    ...
    private int _32_statement_control_use() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _37_term_hyperwhatever() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _42_scope_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _44_multi_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _45_variable_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _46_routine_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
