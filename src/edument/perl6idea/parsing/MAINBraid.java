...
public class MAINBraid extends Cursor<MAINBraid> {
    ...
    public int runRule() {
        ...
        case 76:
            ...
            break;
        case 77:
            result = this._77_term_self();
            break;
        case 78:
            result = this._78_term_whatever();
            break;
        case 79:
            result = this._79_term_hyperwhatever();
            break;
        case 80:
            result = this._80_args();
            break;
        case 81:
            result = this._81_semiarglist();
            break;
        case 82:
            result = this._82_arglist();
            break;
        case 83:
            result = this._83_variable();
            break;
        case 84:
            result = this._84_scope_declarator();
            break;
        case 85:
            result = this._85_declarator();
            break;
        case 86:
            result = this._86_multi_declarator();
            break;
        case 87:
            result = this._87_variable_declarator();
            break;
        case 88:
            result = this._88_routine_declarator();
            break;
        case 89:
            result = this._89_routine_def();
            break;
        case 90:
            result = this._90_method_def();
            break;
        case 91:
            result = this._91_onlystar();
            break;
        case 92:
            result = this._92_param_sep();
            break;
        case 93:
            result = this._93_signature();
            break;
        case 94:
            result = this._94_parameter();
            break;
        case 95:
            result = this._95_param_var();
            break;
        case 96:
            result = this._96_named_param();
            break;
        case 97:
            result = this._97_default_value();
            break;
        case 98:
            result = this._98_post_constraint();
            break;
        case 99:
            result = this._99_initializer();
            break;
        case 100:
            result = this._100_sigil();
            break;
        case 101:
            result = this._101_twigil();
            break;
        case 102:
            result = this._102_package_declarator();
            break;
        case 103:
            result = this._103_package_kind();
            break;
        case 104:
            result = this._104_package_def();
            break;
        case 105:
            result = this._105_desigilname();
            break;
        case 106:
            result = this._106_value();
            break;
        case 107:
            result = this._107_number();
            break;
        case 108:
            result = this._108_numish();
            break;
        case 109:
            result = this._109_dec_number();
            break;
        case 110:
            result = this._110_escale();
            break;
        case 111:
            result = this._111_sign();
            break;
        case 112:
            result = this._112_integer();
            break;
        case 113:
            result = this._113_integer_lex();
            break;
        case 114:
            result = this._114_decint();
            break;
        case 115:
            result = this._115_hexint();
            break;
        case 116:
            result = this._116_octint();
            break;
        case 117:
            result = this._117_binint();
            break;
        case 118:
            result = this._118_charname();
            break;
        case 119:
            result = this._119_hexints();
            break;
        case 120:
            result = this._120_octints();
            break;
        case 121:
            result = this._121_charnames();
            break;
        case 122:
            result = this._122_charspec();
            break;
        case 123:
            result = this._123_quote();
            break;
        case 124:
            result = this._124_quote_Q();
            break;
        case 125:
            result = this._125_quote_q();
            break;
        case 126:
            result = this._126_quote_qq();
            break;
        case 127:
            result = this._127_quote_nibbler();
            break;
        case 128:
            result = this._128_starter();
            break;
        case 129:
            result = this._129_stopper();
            break;
        case 130:
            result = this._130_quote_escape();
            break;
        case 131:
            result = this._131_EXPR();
            break;
        case 132:
            result = this._132_prefixish();
            break;
        case 133:
            result = this._133_prefix();
            break;
        case 134:
            result = this._134_postfixish();
            break;
        case 135:
            result = this._135_postfix();
            break;
        case 136:
            result = this._136_dotty();
            break;
        case 137:
            result = this._137_dottyop();
            break;
        case 138:
            result = this._138_privop();
            break;
        case 139:
            result = this._139_methodop();
            break;
        case 140:
            result = this._140_postcircumfix();
            break;
        case 141:
            result = this._141_infixish();
            break;
        case 142:
            result = this._142_infixstopper();
            break;
        case 143:
            result = this._143_infix();
            break;
        case 144:
            result = this._144_termish();
            break;
        case 145:
    ...
    private int _79_term_hyperwhatever() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _84_scope_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _86_multi_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _87_variable_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _88_routine_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _98_post_constraint() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _102_package_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _127_quote_nibbler() {
        int rep;
        while (true) {
            switch (this.state) {
            case 0:
    ...
    private int _140_postcircumfix() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
