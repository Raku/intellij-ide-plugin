...
public class MAINBraid extends Cursor<MAINBraid> {
    ...
    public int runRule() {
        ...
        case 101:
            ...
            break;
        case 102:
            result = this._102_trait();
            break;
        case 103:
            result = this._103_trait_mod();
            break;
        case 104:
            result = this._104_regex_declarator();
            break;
        case 105:
            result = this._105_regex_def();
            break;
        case 106:
            result = this._106_sigil();
            break;
        case 107:
            result = this._107_twigil();
            break;
        case 108:
            result = this._108_package_declarator();
            break;
        case 109:
            result = this._109_package_kind();
            break;
        case 110:
            result = this._110_package_def();
            break;
        case 111:
            result = this._111_desigilname();
            break;
        case 112:
            result = this._112_value();
            break;
        case 113:
            result = this._113_number();
            break;
        case 114:
            result = this._114_numish();
            break;
        case 115:
            result = this._115_dec_number();
            break;
        case 116:
            result = this._116_escale();
            break;
        case 117:
            result = this._117_sign();
            break;
        case 118:
            result = this._118_integer();
            break;
        case 119:
            result = this._119_integer_lex();
            break;
        case 120:
            result = this._120_decint();
            break;
        case 121:
            result = this._121_hexint();
            break;
        case 122:
            result = this._122_octint();
            break;
        case 123:
            result = this._123_binint();
            break;
        case 124:
            result = this._124_charname();
            break;
        case 125:
            result = this._125_hexints();
            break;
        case 126:
            result = this._126_octints();
            break;
        case 127:
            result = this._127_charnames();
            break;
        case 128:
            result = this._128_charspec();
            break;
        case 129:
            result = this._129_typename();
            break;
        case 130:
            result = this._130_quote();
            break;
        case 131:
            result = this._131_quote_Q();
            break;
        case 132:
            result = this._132_quote_q();
            break;
        case 133:
            result = this._133_quote_qq();
            break;
        case 134:
            result = this._134_quote_nibbler();
            break;
        case 135:
            result = this._135_starter();
            break;
        case 136:
            result = this._136_stopper();
            break;
        case 137:
            result = this._137_quote_escape();
            break;
        case 138:
            result = this._138_circumfix();
            break;
        case 139:
            result = this._139_EXPR();
            break;
        case 140:
            result = this._140_prefixish();
            break;
        case 141:
            result = this._141_prefix();
            break;
        case 142:
            result = this._142_postfixish();
            break;
        case 143:
            result = this._143_postfix();
            break;
        case 144:
            result = this._144_dotty();
            break;
        case 145:
            result = this._145_dottyop();
            break;
        case 146:
            result = this._146_privop();
            break;
        case 147:
            result = this._147_methodop();
            break;
        case 148:
            result = this._148_postcircumfix();
            break;
        case 149:
            result = this._149_infixish();
            break;
        case 150:
            result = this._150_infixstopper();
            break;
        case 151:
            result = this._151_infix();
            break;
        case 152:
            result = this._152_termish();
            break;
        case 153:
            result = this._153_enter_regex_nibblier();
            break;
        case 154:
            result = this._154_regex_nibbler();
            break;
        case 155:
            result = this._155_rxstopper();
            break;
        case 156:
            result = this._156_rxinfixstopper();
            break;
        case 157:
            result = this._157_termseq();
            break;
        case 158:
            result = this._158_termaltseq();
            break;
        case 159:
            result = this._159_termconjseq();
            break;
        case 160:
            result = this._160_termalt();
            break;
        case 161:
            result = this._161_termconj();
            break;
        case 162:
            result = this._162_rxtermish();
            break;
        case 163:
            result = this._163_SIGOK();
            break;
        case 164:
            result = this._164_sigmaybe();
            break;
        case 165:
            result = this._165_normspace();
            break;
        case 166:
            result = this._166_quantified_atom();
            break;
        case 167:
            result = this._167_separator();
            break;
        case 168:
            result = this._168_atom();
            break;
        case 169:
            result = this._169_quantifier();
            break;
        case 170:
            result = this._170_rxcodeblock();
            break;
        case 171:
            result = this._171_backmod();
            break;
        case 172:
            result = this._172_metachar();
            break;
        case 173:
            result = this._173_rxq();
            break;
        case 174:
            result = this._174_rxqq();
            break;
        case 175:
            result = this._175_rxqw();
            break;
        case 176:
            result = this._176_backslash();
            break;
        case 177:
            result = this._177_assertion();
            break;
        case 178:
            result = this._178_rxarglist();
            break;
        case 179:
            result = this._179_cclass_elem();
            break;
        case 180:
            result = this._180_cclass_backslash();
            break;
        case 181:
    ...
    private int _104_regex_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _108_package_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _134_quote_nibbler() {
        int rep;
        while (true) {
            switch (this.state) {
            case 0:
    ...
    private int _148_postcircumfix() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _153_enter_regex_nibblier() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(2);
    ...
    private int _154_regex_nibbler() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _156_rxinfixstopper() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _166_quantified_atom() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _180_cclass_backslash() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
