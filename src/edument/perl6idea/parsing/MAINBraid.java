...
public class MAINBraid extends Cursor<MAINBraid> {
    ...
    public int runRule() {
        ...
        case 89:
            ...
            break;
        case 90:
            result = this._90_initializer();
            break;
        case 91:
            result = this._91_sigil();
            break;
        case 92:
            result = this._92_twigil();
            break;
        case 93:
            result = this._93_package_declarator();
            break;
        case 94:
            result = this._94_package_kind();
            break;
        case 95:
            result = this._95_package_def();
            break;
        case 96:
            result = this._96_desigilname();
            break;
        case 97:
            result = this._97_value();
            break;
        case 98:
            result = this._98_number();
            break;
        case 99:
            result = this._99_numish();
            break;
        case 100:
            result = this._100_dec_number();
            break;
        case 101:
            result = this._101_escale();
            break;
        case 102:
            result = this._102_sign();
            break;
        case 103:
            result = this._103_integer();
            break;
        case 104:
            result = this._104_integer_lex();
            break;
        case 105:
            result = this._105_decint();
            break;
        case 106:
            result = this._106_hexint();
            break;
        case 107:
            result = this._107_octint();
            break;
        case 108:
            result = this._108_binint();
            break;
        case 109:
            result = this._109_charname();
            break;
        case 110:
            result = this._110_hexints();
            break;
        case 111:
            result = this._111_octints();
            break;
        case 112:
            result = this._112_charnames();
            break;
        case 113:
            result = this._113_charspec();
            break;
        case 114:
            result = this._114_quote();
            break;
        case 115:
            result = this._115_quote_Q();
            break;
        case 116:
            result = this._116_quote_q();
            break;
        case 117:
            result = this._117_quote_qq();
            break;
        case 118:
            result = this._118_quote_nibbler();
            break;
        case 119:
            result = this._119_starter();
            break;
        case 120:
            result = this._120_stopper();
            break;
        case 121:
            result = this._121_quote_escape();
            break;
        case 122:
            result = this._122_EXPR();
            break;
        case 123:
            result = this._123_prefixish();
            break;
        case 124:
            result = this._124_prefix();
            break;
        case 125:
            result = this._125_postfixish();
            break;
        case 126:
            result = this._126_postfix();
            break;
        case 127:
            result = this._127_dotty();
            break;
        case 128:
            result = this._128_dottyop();
            break;
        case 129:
            result = this._129_methodop();
            break;
        case 130:
            result = this._130_postcircumfix();
            break;
        case 131:
            result = this._131_infixish();
            break;
        case 132:
            result = this._132_infixstopper();
            break;
        case 133:
            result = this._133_infix();
            break;
        case 134:
            result = this._134_termish();
            break;
        case 135:
    ...
    private int _93_package_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _118_quote_nibbler() {
        int rep;
        while (true) {
            switch (this.state) {
            case 0:
    ...
    private int _130_postcircumfix() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
