...
public class MAINBraid extends Cursor<MAINBraid> {
    ...
    public int runRule() {
        ...
        case 137:
            ...
            break;
        case 138:
            result = this._138_integer();
            break;
        case 139:
            result = this._139_signed_integer();
            break;
        case 140:
            result = this._140_integer_lex();
            break;
        case 141:
            result = this._141_decint();
            break;
        case 142:
            result = this._142_hexint();
            break;
        case 143:
            result = this._143_octint();
            break;
        case 144:
            result = this._144_binint();
            break;
        case 145:
            result = this._145_charname();
            break;
        case 146:
            result = this._146_hexints();
            break;
        case 147:
            result = this._147_octints();
            break;
        case 148:
            result = this._148_charnames();
            break;
        case 149:
            result = this._149_charspec();
            break;
        case 150:
            result = this._150_typename();
            break;
        case 151:
            result = this._151_quote();
            break;
        case 152:
            result = this._152_quote_Q();
            break;
        case 153:
            result = this._153_quote_q();
            break;
        case 154:
            result = this._154_quote_qq();
            break;
        case 155:
            result = this._155_quote_nibbler();
            break;
        case 156:
            result = this._156_starter();
            break;
        case 157:
            result = this._157_stopper();
            break;
        case 158:
            result = this._158_quote_escape();
            break;
        case 159:
            result = this._159_circumfix();
            break;
        case 160:
            result = this._160_EXPR();
            break;
        case 161:
            result = this._161_prefixish();
            break;
        case 162:
            result = this._162_prefix();
            break;
        case 163:
            result = this._163_postfixish();
            break;
        case 164:
            result = this._164_postfix();
            break;
        case 165:
            result = this._165_dotty();
            break;
        case 166:
            result = this._166_dottyop();
            break;
        case 167:
            result = this._167_privop();
            break;
        case 168:
            result = this._168_methodop();
            break;
        case 169:
            result = this._169_postcircumfix();
            break;
        case 170:
            result = this._170_infixish();
            break;
        case 171:
            result = this._171_infixstopper();
            break;
        case 172:
            result = this._172_infix();
            break;
        case 173:
            result = this._173_termish();
            break;
        case 174:
            result = this._174_enter_regex_nibblier();
            break;
        case 175:
            result = this._175_regex_nibbler();
            break;
        case 176:
            result = this._176_rxstopper();
            break;
        case 177:
            result = this._177_rxinfixstopper();
            break;
        case 178:
            result = this._178_termseq();
            break;
        case 179:
            result = this._179_termaltseq();
            break;
        case 180:
            result = this._180_termconjseq();
            break;
        case 181:
            result = this._181_termalt();
            break;
        case 182:
            result = this._182_termconj();
            break;
        case 183:
            result = this._183_rxtermish();
            break;
        case 184:
            result = this._184_SIGOK();
            break;
        case 185:
            result = this._185_sigmaybe();
            break;
        case 186:
            result = this._186_normspace();
            break;
        case 187:
            result = this._187_quantified_atom();
            break;
        case 188:
            result = this._188_separator();
            break;
        case 189:
            result = this._189_atom();
            break;
        case 190:
            result = this._190_quantifier();
            break;
        case 191:
            result = this._191_rxcodeblock();
            break;
        case 192:
            result = this._192_backmod();
            break;
        case 193:
            result = this._193_metachar();
            break;
        case 194:
            result = this._194_rxq();
            break;
        case 195:
            result = this._195_rxqq();
            break;
        case 196:
            result = this._196_rxqw();
            break;
        case 197:
            result = this._197_backslash();
            break;
        case 198:
            result = this._198_assertion();
            break;
        case 199:
            result = this._199_rxarglist();
            break;
        case 200:
            result = this._200_cclass_elem();
            break;
        case 201:
            result = this._201_cclass_backslash();
            break;
        case 202:
    ...
    private int _139_signed_integer() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _155_quote_nibbler() {
        int rep;
        while (true) {
            switch (this.state) {
            case 0:
    ...
    private int _169_postcircumfix() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _174_enter_regex_nibblier() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(2);
    ...
    private int _175_regex_nibbler() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _177_rxinfixstopper() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _187_quantified_atom() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _201_cclass_backslash() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
