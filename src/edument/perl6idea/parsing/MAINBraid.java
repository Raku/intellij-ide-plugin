...
public class MAINBraid extends Cursor<MAINBraid> {
    ...
    public int runRule() {
        ...
        case 26:
            ...
            break;
        case 27:
            result = this._27_statement_control_unless();
            break;
        case 28:
            result = this._28_statement_control_without();
            break;
        case 29:
            result = this._29_statement_control_while();
            break;
        case 30:
            result = this._30_statement_control_until();
            break;
        case 31:
            result = this._31_statement_control_for();
            break;
        case 32:
            result = this._32_statement_control_whenever();
            break;
        case 33:
            result = this._33_statement_control_use();
            break;
        case 34:
            result = this._34_term();
            break;
        case 35:
            result = this._35_term_ident();
            break;
        case 36:
            result = this._36_term_name();
            break;
        case 37:
            result = this._37_term_whatever();
            break;
        case 38:
            result = this._38_term_hyperwhatever();
            break;
        case 39:
            result = this._39_args();
            break;
        case 40:
            result = this._40_semiarglist();
            break;
        case 41:
            result = this._41_arglist();
            break;
        case 42:
            result = this._42_variable();
            break;
        case 43:
            result = this._43_scope_declarator();
            break;
        case 44:
            result = this._44_declarator();
            break;
        case 45:
            result = this._45_multi_declarator();
            break;
        case 46:
            result = this._46_variable_declarator();
            break;
        case 47:
            result = this._47_routine_declarator();
            break;
        case 48:
            result = this._48_routine_def();
            break;
        case 49:
            result = this._49_onlystar();
            break;
        case 50:
            result = this._50_initializer();
            break;
        case 51:
            result = this._51_sigil();
            break;
        case 52:
            result = this._52_twigil();
            break;
        case 53:
            result = this._53_desigilname();
            break;
        case 54:
            result = this._54_value();
            break;
        case 55:
            result = this._55_number();
            break;
        case 56:
            result = this._56_numish();
            break;
        case 57:
            result = this._57_dec_number();
            break;
        case 58:
            result = this._58_escale();
            break;
        case 59:
            result = this._59_sign();
            break;
        case 60:
            result = this._60_integer();
            break;
        case 61:
            result = this._61_integer_lex();
            break;
        case 62:
            result = this._62_decint();
            break;
        case 63:
            result = this._63_hexint();
            break;
        case 64:
            result = this._64_octint();
            break;
        case 65:
            result = this._65_binint();
            break;
        case 66:
            result = this._66_charname();
            break;
        case 67:
            result = this._67_hexints();
            break;
        case 68:
            result = this._68_octints();
            break;
        case 69:
            result = this._69_charnames();
            break;
        case 70:
            result = this._70_charspec();
            break;
        case 71:
            result = this._71_quote();
            break;
        case 72:
            result = this._72_quote_Q();
            break;
        case 73:
            result = this._73_quote_q();
            break;
        case 74:
            result = this._74_quote_qq();
            break;
        case 75:
            result = this._75_quote_nibbler();
            break;
        case 76:
            result = this._76_starter();
            break;
        case 77:
            result = this._77_stopper();
            break;
        case 78:
            result = this._78_quote_escape();
            break;
        case 79:
            result = this._79_EXPR();
            break;
        case 80:
            result = this._80_prefixish();
            break;
        case 81:
            result = this._81_prefix();
            break;
        case 82:
            result = this._82_postfixish();
            break;
        case 83:
            result = this._83_postfix();
            break;
        case 84:
            result = this._84_dotty();
            break;
        case 85:
            result = this._85_dottyop();
            break;
        case 86:
            result = this._86_methodop();
            break;
        case 87:
            result = this._87_infixish();
            break;
        case 88:
            result = this._88_infixstopper();
            break;
        case 89:
            result = this._89_infix();
            break;
        case 90:
            result = this._90_termish();
            break;
        case 91:
    ...
    private int _27_statement_control_unless() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _28_statement_control_without() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _29_statement_control_while() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _30_statement_control_until() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _31_statement_control_for() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _32_statement_control_whenever() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _33_statement_control_use() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _38_term_hyperwhatever() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _43_scope_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _45_multi_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _46_variable_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _47_routine_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
