...
public class MAINBraid extends Cursor<MAINBraid> {
    ...
    public int runRule() {
        ...
        case 80:
            ...
            break;
        case 81:
            result = this._81_args();
            break;
        case 82:
            result = this._82_semiarglist();
            break;
        case 83:
            result = this._83_arglist();
            break;
        case 84:
            result = this._84_variable();
            break;
        case 85:
            result = this._85_scope_declarator();
            break;
        case 86:
            result = this._86_declarator();
            break;
        case 87:
            result = this._87_multi_declarator();
            break;
        case 88:
            result = this._88_variable_declarator();
            break;
        case 89:
            result = this._89_routine_declarator();
            break;
        case 90:
            result = this._90_routine_def();
            break;
        case 91:
            result = this._91_method_def();
            break;
        case 92:
            result = this._92_onlystar();
            break;
        case 93:
            result = this._93_param_sep();
            break;
        case 94:
            result = this._94_signature();
            break;
        case 95:
            result = this._95_parameter();
            break;
        case 96:
            result = this._96_param_var();
            break;
        case 97:
            result = this._97_named_param();
            break;
        case 98:
            result = this._98_default_value();
            break;
        case 99:
            result = this._99_post_constraint();
            break;
        case 100:
            result = this._100_initializer();
            break;
        case 101:
            result = this._101_sigil();
            break;
        case 102:
            result = this._102_twigil();
            break;
        case 103:
            result = this._103_package_declarator();
            break;
        case 104:
            result = this._104_package_kind();
            break;
        case 105:
            result = this._105_package_def();
            break;
        case 106:
            result = this._106_desigilname();
            break;
        case 107:
            result = this._107_value();
            break;
        case 108:
            result = this._108_number();
            break;
        case 109:
            result = this._109_numish();
            break;
        case 110:
            result = this._110_dec_number();
            break;
        case 111:
            result = this._111_escale();
            break;
        case 112:
            result = this._112_sign();
            break;
        case 113:
            result = this._113_integer();
            break;
        case 114:
            result = this._114_integer_lex();
            break;
        case 115:
            result = this._115_decint();
            break;
        case 116:
            result = this._116_hexint();
            break;
        case 117:
            result = this._117_octint();
            break;
        case 118:
            result = this._118_binint();
            break;
        case 119:
            result = this._119_charname();
            break;
        case 120:
            result = this._120_hexints();
            break;
        case 121:
            result = this._121_octints();
            break;
        case 122:
            result = this._122_charnames();
            break;
        case 123:
            result = this._123_charspec();
            break;
        case 124:
            result = this._124_quote();
            break;
        case 125:
            result = this._125_quote_Q();
            break;
        case 126:
            result = this._126_quote_q();
            break;
        case 127:
            result = this._127_quote_qq();
            break;
        case 128:
            result = this._128_quote_nibbler();
            break;
        case 129:
            result = this._129_starter();
            break;
        case 130:
            result = this._130_stopper();
            break;
        case 131:
            result = this._131_quote_escape();
            break;
        case 132:
            result = this._132_EXPR();
            break;
        case 133:
            result = this._133_prefixish();
            break;
        case 134:
            result = this._134_prefix();
            break;
        case 135:
            result = this._135_postfixish();
            break;
        case 136:
            result = this._136_postfix();
            break;
        case 137:
            result = this._137_dotty();
            break;
        case 138:
            result = this._138_dottyop();
            break;
        case 139:
            result = this._139_privop();
            break;
        case 140:
            result = this._140_methodop();
            break;
        case 141:
            result = this._141_postcircumfix();
            break;
        case 142:
            result = this._142_infixish();
            break;
        case 143:
            result = this._143_infixstopper();
            break;
        case 144:
            result = this._144_infix();
            break;
        case 145:
            result = this._145_termish();
            break;
        case 146:
    ...
    private int _85_scope_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _87_multi_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _88_variable_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _89_routine_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _99_post_constraint() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _103_package_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _128_quote_nibbler() {
        int rep;
        while (true) {
            switch (this.state) {
            case 0:
    ...
    private int _141_postcircumfix() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
