...
public class MAINBraid extends Cursor<MAINBraid> {
    ...
    public int runRule() {
        ...
        case 31:
            ...
            break;
        case 32:
            result = this._32_statement_control_for();
            break;
        case 33:
            result = this._33_statement_control_whenever();
            break;
        case 34:
            result = this._34_statement_control_use();
            break;
        case 35:
            result = this._35_term();
            break;
        case 36:
            result = this._36_term_ident();
            break;
        case 37:
            result = this._37_term_name();
            break;
        case 38:
            result = this._38_term_whatever();
            break;
        case 39:
            result = this._39_term_hyperwhatever();
            break;
        case 40:
            result = this._40_args();
            break;
        case 41:
            result = this._41_semiarglist();
            break;
        case 42:
            result = this._42_arglist();
            break;
        case 43:
            result = this._43_variable();
            break;
        case 44:
            result = this._44_scope_declarator();
            break;
        case 45:
            result = this._45_declarator();
            break;
        case 46:
            result = this._46_multi_declarator();
            break;
        case 47:
            result = this._47_variable_declarator();
            break;
        case 48:
            result = this._48_routine_declarator();
            break;
        case 49:
            result = this._49_routine_def();
            break;
        case 50:
            result = this._50_onlystar();
            break;
        case 51:
            result = this._51_initializer();
            break;
        case 52:
            result = this._52_sigil();
            break;
        case 53:
            result = this._53_twigil();
            break;
        case 54:
            result = this._54_desigilname();
            break;
        case 55:
            result = this._55_value();
            break;
        case 56:
            result = this._56_number();
            break;
        case 57:
            result = this._57_numish();
            break;
        case 58:
            result = this._58_dec_number();
            break;
        case 59:
            result = this._59_escale();
            break;
        case 60:
            result = this._60_sign();
            break;
        case 61:
            result = this._61_integer();
            break;
        case 62:
            result = this._62_integer_lex();
            break;
        case 63:
            result = this._63_decint();
            break;
        case 64:
            result = this._64_hexint();
            break;
        case 65:
            result = this._65_octint();
            break;
        case 66:
            result = this._66_binint();
            break;
        case 67:
            result = this._67_charname();
            break;
        case 68:
            result = this._68_hexints();
            break;
        case 69:
            result = this._69_octints();
            break;
        case 70:
            result = this._70_charnames();
            break;
        case 71:
            result = this._71_charspec();
            break;
        case 72:
            result = this._72_quote();
            break;
        case 73:
            result = this._73_quote_Q();
            break;
        case 74:
            result = this._74_quote_q();
            break;
        case 75:
            result = this._75_quote_qq();
            break;
        case 76:
            result = this._76_quote_nibbler();
            break;
        case 77:
            result = this._77_starter();
            break;
        case 78:
            result = this._78_stopper();
            break;
        case 79:
            result = this._79_quote_escape();
            break;
        case 80:
            result = this._80_EXPR();
            break;
        case 81:
            result = this._81_prefixish();
            break;
        case 82:
            result = this._82_prefix();
            break;
        case 83:
            result = this._83_postfixish();
            break;
        case 84:
            result = this._84_postfix();
            break;
        case 85:
            result = this._85_dotty();
            break;
        case 86:
            result = this._86_dottyop();
            break;
        case 87:
            result = this._87_methodop();
            break;
        case 88:
            result = this._88_infixish();
            break;
        case 89:
            result = this._89_infixstopper();
            break;
        case 90:
            result = this._90_infix();
            break;
        case 91:
            result = this._91_termish();
            break;
        case 92:
    ...
    private int _32_statement_control_for() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _33_statement_control_whenever() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _34_statement_control_use() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _39_term_hyperwhatever() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _44_scope_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _46_multi_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _47_variable_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _48_routine_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
