...
public class MAINBraid extends Cursor<MAINBraid> {
    ...
    public int runRule() {
        ...
        case 170:
            ...
            break;
        case 171:
            result = this._171_rxqw();
            break;
        case 172:
            result = this._172_backslash();
            break;
        case 173:
            result = this._173_assertion();
            break;
        case 174:
            result = this._174_rxarglist();
            break;
        case 175:
            result = this._175_cclass_elem();
            break;
        case 176:
            result = this._176_cclass_backslash();
            break;
        case 177:
    ...
    private int _176_cclass_backslash() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
