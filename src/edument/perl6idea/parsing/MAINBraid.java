...
public class MAINBraid extends Cursor<MAINBraid> {
    ...
    public int runRule() {
        ...
        case 43:
            ...
            break;
        case 44:
            result = this._44_statement_mod_cond_keyword();
            break;
        case 45:
            result = this._45_statement_mod_cond();
            break;
        case 46:
            result = this._46_statement_mod_loop_keyword();
            break;
        case 47:
            result = this._47_statement_mod_loop();
            break;
        case 48:
            result = this._48_term();
            break;
        case 49:
            result = this._49_term_ident();
            break;
        case 50:
            result = this._50_term_name();
            break;
        case 51:
            result = this._51_term_whatever();
            break;
        case 52:
            result = this._52_term_hyperwhatever();
            break;
        case 53:
            result = this._53_args();
            break;
        case 54:
            result = this._54_semiarglist();
            break;
        case 55:
            result = this._55_arglist();
            break;
        case 56:
            result = this._56_variable();
            break;
        case 57:
            result = this._57_scope_declarator();
            break;
        case 58:
            result = this._58_declarator();
            break;
        case 59:
            result = this._59_multi_declarator();
            break;
        case 60:
            result = this._60_variable_declarator();
            break;
        case 61:
            result = this._61_routine_declarator();
            break;
        case 62:
            result = this._62_routine_def();
            break;
        case 63:
            result = this._63_onlystar();
            break;
        case 64:
            result = this._64_initializer();
            break;
        case 65:
            result = this._65_sigil();
            break;
        case 66:
            result = this._66_twigil();
            break;
        case 67:
            result = this._67_desigilname();
            break;
        case 68:
            result = this._68_value();
            break;
        case 69:
            result = this._69_number();
            break;
        case 70:
            result = this._70_numish();
            break;
        case 71:
            result = this._71_dec_number();
            break;
        case 72:
            result = this._72_escale();
            break;
        case 73:
            result = this._73_sign();
            break;
        case 74:
            result = this._74_integer();
            break;
        case 75:
            result = this._75_integer_lex();
            break;
        case 76:
            result = this._76_decint();
            break;
        case 77:
            result = this._77_hexint();
            break;
        case 78:
            result = this._78_octint();
            break;
        case 79:
            result = this._79_binint();
            break;
        case 80:
            result = this._80_charname();
            break;
        case 81:
            result = this._81_hexints();
            break;
        case 82:
            result = this._82_octints();
            break;
        case 83:
            result = this._83_charnames();
            break;
        case 84:
            result = this._84_charspec();
            break;
        case 85:
            result = this._85_quote();
            break;
        case 86:
            result = this._86_quote_Q();
            break;
        case 87:
            result = this._87_quote_q();
            break;
        case 88:
            result = this._88_quote_qq();
            break;
        case 89:
            result = this._89_quote_nibbler();
            break;
        case 90:
            result = this._90_starter();
            break;
        case 91:
            result = this._91_stopper();
            break;
        case 92:
            result = this._92_quote_escape();
            break;
        case 93:
            result = this._93_EXPR();
            break;
        case 94:
            result = this._94_prefixish();
            break;
        case 95:
            result = this._95_prefix();
            break;
        case 96:
            result = this._96_postfixish();
            break;
        case 97:
            result = this._97_postfix();
            break;
        case 98:
            result = this._98_dotty();
            break;
        case 99:
            result = this._99_dottyop();
            break;
        case 100:
            result = this._100_methodop();
            break;
        case 101:
            result = this._101_infixish();
            break;
        case 102:
            result = this._102_infixstopper();
            break;
        case 103:
            result = this._103_infix();
            break;
        case 104:
            result = this._104_termish();
            break;
        case 105:
    ...
    private int _44_statement_mod_cond_keyword() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _45_statement_mod_cond() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _46_statement_mod_loop_keyword() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _47_statement_mod_loop() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _52_term_hyperwhatever() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _57_scope_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _59_multi_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _60_variable_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _61_routine_declarator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
