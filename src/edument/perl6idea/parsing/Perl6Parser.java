...
public class Perl6Parser implements PsiParser {
    ...
    private boolean method_def_16_quant_5(PsiBuilder builder, OPP opp) {
        if (!(this.trait_41(builder))) {
            return false;
        }
        return true;
    ...
    private boolean method_def_16_quant_7(PsiBuilder builder, OPP opp) {
        if (!(this.ws_236(builder))) {
            return false;
        }
        return true;
    ...
    private boolean method_def_16_alt_8(PsiBuilder builder, OPP opp) {
        if (!(this.blockoid_234(builder))) {
            return false;
        }
        PsiBuilder.Marker quantMarker8;
        quantMarker8 = builder.mark();
        if (this.method_def_16_quant_7(builder, opp)) {
            quantMarker8.drop();
        } else {
            quantMarker8.rollbackTo();
        }
    ...
    private boolean method_def_16_quant_9(PsiBuilder builder, OPP opp) {
        if (!(this.ws_236(builder))) {
            return false;
        }
        return true;
    ...
    private boolean method_def_16_alt_10(PsiBuilder builder, OPP opp) {
        if (!(this.onlystar_119(builder))) {
            return false;
        }
        PsiBuilder.Marker quantMarker10;
        quantMarker10 = builder.mark();
        if (this.method_def_16_quant_9(builder, opp)) {
            quantMarker10.drop();
        } else {
            quantMarker10.rollbackTo();
        }
    ...
    private boolean method_def_16(PsiBuilder builder) {
        ...
        while (true) {
            ...
            if (this.method_def_16_quant_5(builder, opp)) {
                quantMarker6.drop();
            } else {
        ...
        if (this.method_def_16_alt_10(builder, opp)) {
            altMarker11.drop();
        } else {
            altMarker11.rollbackTo();
            PsiBuilder.Marker altMarker9;;
            altMarker9 = builder.mark();
            if (this.method_def_16_alt_8(builder, opp)) {
                altMarker9.drop();
            } else {
    ...
    private boolean semilist_33_quant_2(PsiBuilder builder, OPP opp) {
        if (!(this.ws_236(builder))) {
            return false;
        }
        return true;
    ...
    private boolean semilist_33_quant_3(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker marker2;
        marker2 = builder.mark();
        ...
        PsiBuilder.Marker quantMarker4;
        quantMarker4 = builder.mark();
        if (this.semilist_33_quant_2(builder, opp)) {
            quantMarker4.drop();
        } else {
            quantMarker4.rollbackTo();
        }
    ...
    private boolean semilist_33_alt_4(PsiBuilder builder, OPP opp) {
        while (true) {
            PsiBuilder.Marker quantMarker5;;
            quantMarker5 = builder.mark();
            if (this.semilist_33_quant_3(builder, opp)) {
                quantMarker5.drop();
            } else {
                quantMarker5.rollbackTo();
                break;
    ...
    private boolean semilist_33_alt_5(PsiBuilder builder, OPP opp) {
    ...
    private boolean semilist_33(PsiBuilder builder) {
        ...
        PsiBuilder.Marker altMarker7;
        altMarker7 = builder.mark();
        if (this.semilist_33_alt_5(builder, opp)) {
            altMarker7.drop();
        } else {
            altMarker7.rollbackTo();
            PsiBuilder.Marker altMarker6;;
            altMarker6 = builder.mark();
            if (this.semilist_33_alt_4(builder, opp)) {
                altMarker6.drop();
            } else {
                altMarker6.rollbackTo();
                return false;
    ...
    private boolean type_declarator_62_quant_3(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
    ...
    private boolean type_declarator_62_alt_4(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker quantMarker4;
        quantMarker4 = builder.mark();
        if (this.type_declarator_62_quant_3(builder, opp)) {
            quantMarker4.drop();
        } else {
            quantMarker4.rollbackTo();
        }
    ...
    private boolean type_declarator_62_quant_5(PsiBuilder builder, OPP opp) {
        if (!(this.trait_41(builder))) {
            return false;
        }
        return true;
    ...
    private boolean type_declarator_62_alt_8(PsiBuilder builder, OPP opp) {
        ...
        PsiBuilder.Marker altMarker5;
        altMarker5 = builder.mark();
        if (this.type_declarator_62_alt_4(builder, opp)) {
            altMarker5.drop();
        } else {
            altMarker5.rollbackTo();
            PsiBuilder.Marker altMarker3;;
        ...
        while (true) {
            PsiBuilder.Marker quantMarker6;;
            quantMarker6 = builder.mark();
            if (this.type_declarator_62_quant_5(builder, opp)) {
                quantMarker6.drop();
            } else {
                quantMarker6.rollbackTo();
                break;
    ...
    private boolean type_declarator_62_alt_10(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == Perl6TokenTypes.NAME) {
            builder.advanceLexer();
        } else {
            return false;
    ...
    private boolean type_declarator_62_quant_11(PsiBuilder builder, OPP opp) {
        if (!(this.trait_41(builder))) {
            return false;
        }
        return true;
    ...
    private boolean type_declarator_62_alt_13(PsiBuilder builder, OPP opp) {
        if (!(this.EXPR_17(builder))) {
            return false;
        }
        return true;
    ...
    private boolean type_declarator_62_quant_14(PsiBuilder builder, OPP opp) {
        ...
        PsiBuilder.Marker altMarker15;
        altMarker15 = builder.mark();
        if (this.type_declarator_62_alt_13(builder, opp)) {
            altMarker15.drop();
        } else {
            altMarker15.rollbackTo();
            PsiBuilder.Marker altMarker14;;
    ...
    private boolean type_declarator_62_quant_17(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker altMarker12;
        altMarker12 = builder.mark();
        if (this.type_declarator_62_alt_10(builder, opp)) {
            altMarker12.drop();
        } else {
            altMarker12.rollbackTo();
            PsiBuilder.Marker altMarker11;;
        ...
        while (true) {
            PsiBuilder.Marker quantMarker13;;
            quantMarker13 = builder.mark();
            if (this.type_declarator_62_quant_11(builder, opp)) {
                quantMarker13.drop();
            } else {
                quantMarker13.rollbackTo();
                break;
    ...
    private boolean type_declarator_62_alt_18(PsiBuilder builder, OPP opp) {
        ...
        PsiBuilder.Marker quantMarker19;
        quantMarker19 = builder.mark();
        if (this.type_declarator_62_quant_17(builder, opp)) {
            quantMarker19.drop();
        } else {
            quantMarker19.rollbackTo();
        }
    ...
    private boolean type_declarator_62_alt_21(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == Perl6TokenTypes.NAME) {
            builder.advanceLexer();
        } else {
            return false;
    ...
    private boolean type_declarator_62_quant_22(PsiBuilder builder, OPP opp) {
        if (!(this.trait_41(builder))) {
            return false;
        }
        return true;
    ...
    private boolean type_declarator_62_alt_24(PsiBuilder builder, OPP opp) {
    ...
    private boolean type_declarator_62_quant_25(PsiBuilder builder, OPP opp) {
        ...
        PsiBuilder.Marker altMarker27;
        altMarker27 = builder.mark();
        if (this.type_declarator_62_alt_24(builder, opp)) {
            altMarker27.drop();
        } else {
            altMarker27.rollbackTo();
            PsiBuilder.Marker altMarker26;;
    ...
    private boolean type_declarator_62_quant_27(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker altMarker24;
        altMarker24 = builder.mark();
        if (this.type_declarator_62_alt_21(builder, opp)) {
            altMarker24.drop();
        } else {
            altMarker24.rollbackTo();
            PsiBuilder.Marker altMarker23;;
        ...
        while (true) {
            ...
            if (this.type_declarator_62_quant_22(builder, opp)) {
                quantMarker25.drop();
            } else {
    ...
    private boolean type_declarator_62_alt_28(PsiBuilder builder, OPP opp) {
        ...
        if (this.type_declarator_62_quant_27(builder, opp)) {
            quantMarker30.drop();
        } else {
    ...
    private boolean type_declarator_62(PsiBuilder builder) {
        ...
        if (this.type_declarator_62_alt_28(builder, opp)) {
            altMarker31.drop();
        } else {
    ...
    private boolean signature_102_quant_8(PsiBuilder builder, OPP opp) {
        if (!(this.ws_236(builder))) {
            return false;
        }
        return true;
    ...
    private boolean signature_102_alt_11(PsiBuilder builder, OPP opp) {
        if (!(this.typename_134(builder))) {
            return false;
        }
        return true;
    ...
    private boolean signature_102_quant_12(PsiBuilder builder, OPP opp) {
        if (!(this.ws_236(builder))) {
            return false;
        }
        return true;
    ...
    private boolean signature_102_alt_13(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker altMarker12;
        altMarker12 = builder.mark();
        if (this.signature_102_alt_11(builder, opp)) {
            altMarker12.drop();
        } else {
            altMarker12.rollbackTo();
            PsiBuilder.Marker altMarker11;;
        ...
        PsiBuilder.Marker quantMarker13;
        quantMarker13 = builder.mark();
        if (this.signature_102_quant_12(builder, opp)) {
            quantMarker13.drop();
        } else {
            quantMarker13.rollbackTo();
        }
    ...
    private boolean signature_102_quant_14(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker marker9;
        marker9 = builder.mark();
        String tt1;
        tt1 = builder.getTokenText();
        ...
        PsiBuilder.Marker altMarker14;
        altMarker14 = builder.mark();
        if (this.signature_102_alt_13(builder, opp)) {
            altMarker14.drop();
        } else {
            altMarker14.rollbackTo();
            PsiBuilder.Marker altMarker10;;
    ...
    private boolean signature_102(PsiBuilder builder) {
        ...
        PsiBuilder.Marker quantMarker8;
        quantMarker8 = builder.mark();
        if (this.signature_102_quant_8(builder, opp)) {
            quantMarker8.drop();
        } else {
            quantMarker8.rollbackTo();
        }
        PsiBuilder.Marker quantMarker15;
        quantMarker15 = builder.mark();
        if (this.signature_102_quant_14(builder, opp)) {
            quantMarker15.drop();
        } else {
            quantMarker15.rollbackTo();
        }
    ...
    private boolean routine_def_140_quant_5(PsiBuilder builder, OPP opp) {
        if (!(this.trait_41(builder))) {
            return false;
        }
        return true;
    ...
    private boolean routine_def_140_alt_6(PsiBuilder builder, OPP opp) {
        return true;
    }

    private boolean routine_def_140_quant_7(PsiBuilder builder, OPP opp) {
        if (!(this.ws_236(builder))) {
            return false;
        }
        return true;
    ...
    private boolean routine_def_140_alt_8(PsiBuilder builder, OPP opp) {
        if (!(this.blockoid_234(builder))) {
            return false;
        }
        PsiBuilder.Marker quantMarker8;
        quantMarker8 = builder.mark();
        if (this.routine_def_140_quant_7(builder, opp)) {
            quantMarker8.drop();
        } else {
            quantMarker8.rollbackTo();
        }
    ...
    private boolean routine_def_140_quant_9(PsiBuilder builder, OPP opp) {
        if (!(this.ws_236(builder))) {
            return false;
        }
        return true;
    ...
    private boolean routine_def_140_alt_10(PsiBuilder builder, OPP opp) {
        if (!(this.onlystar_119(builder))) {
            return false;
        }
        PsiBuilder.Marker quantMarker10;
        quantMarker10 = builder.mark();
        if (this.routine_def_140_quant_9(builder, opp)) {
            quantMarker10.drop();
        } else {
            quantMarker10.rollbackTo();
        }
    ...
    private boolean routine_def_140(PsiBuilder builder) {
        ...
        while (true) {
            PsiBuilder.Marker quantMarker6;;
            quantMarker6 = builder.mark();
            if (this.routine_def_140_quant_5(builder, opp)) {
                quantMarker6.drop();
            } else {
                quantMarker6.rollbackTo();
                break;
        ...
        PsiBuilder.Marker altMarker11;
        altMarker11 = builder.mark();
        if (this.routine_def_140_alt_10(builder, opp)) {
            altMarker11.drop();
        } else {
            altMarker11.rollbackTo();
            PsiBuilder.Marker altMarker9;;
            altMarker9 = builder.mark();
            if (this.routine_def_140_alt_8(builder, opp)) {
                altMarker9.drop();
            } else {
                altMarker9.rollbackTo();
                PsiBuilder.Marker altMarker7;;
                altMarker7 = builder.mark();
                if (this.routine_def_140_alt_6(builder, opp)) {
                    altMarker7.drop();
                } else {
                    altMarker7.rollbackTo();
                    return false;
    ...
    private boolean initializer_148_alt_9(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == Perl6TokenTypes.INITIALIZER_MISSING) {
            builder.advanceLexer();
        } else {
            return false;
    ...
    private boolean initializer_148_alt_10(PsiBuilder builder, OPP opp) {
        if (!(this.dottyop_112(builder))) {
            return false;
        }
        return true;
    ...
    private boolean initializer_148_alt_11(PsiBuilder builder, OPP opp) {
        ...
        PsiBuilder.Marker altMarker11;
        altMarker11 = builder.mark();
        if (this.initializer_148_alt_10(builder, opp)) {
            altMarker11.drop();
        } else {
            altMarker11.rollbackTo();
            PsiBuilder.Marker altMarker10;;
            altMarker10 = builder.mark();
            if (this.initializer_148_alt_9(builder, opp)) {
                altMarker10.drop();
            } else {
                altMarker10.rollbackTo();
                return false;
    ...
    private boolean initializer_148(PsiBuilder builder) {
        ...
        PsiBuilder.Marker altMarker12;
        altMarker12 = builder.mark();
        if (this.initializer_148_alt_11(builder, opp)) {
            altMarker12.drop();
        } else {
            altMarker12.rollbackTo();
            PsiBuilder.Marker altMarker9;;
