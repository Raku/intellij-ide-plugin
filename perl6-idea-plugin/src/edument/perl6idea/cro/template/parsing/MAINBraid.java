...
public class MAINBraid extends Cursor<MAINBraid> {
    ...
    public int runRule() {
        ...
        case 22:
            ...
            break;
        case 23:
            result = this._23_module_name();
            break;
        case 24:
            result = this._24_sigil_tag_apply();
            break;
        case 25:
            result = this._25_signature();
            break;
        case 26:
            result = this._26_parameter();
            break;
        case 27:
            result = this._27_parameter_name();
            break;
        case 28:
            result = this._28_arglist();
            break;
        case 29:
            result = this._29_argument();
            break;
        case 30:
            result = this._30_expression();
            break;
        case 31:
            result = this._31_nextterm();
            break;
        case 32:
            result = this._32_infixish();
            break;
        case 33:
            result = this._33_infix();
            break;
        case 34:
            result = this._34_term();
            break;
        case 35:
            result = this._35_single_quote_string();
            break;
        case 36:
            result = this._36_int();
            break;
        ...
        case 38:
            ...
            break;
        case 39:
            result = this._39_bool();
            break;
        case 40:
            result = this._40_variable();
            break;
        case 41:
            result = this._41_deref_term();
            break;
        case 42:
            result = this._42_parenthesized_expression();
            break;
        case 43:
            result = this._43_deref();
            break;
        case 44:
            result = this._44_deref_item();
            break;
        case 45:
            result = this._45_deref_item_method();
            break;
        case 46:
            result = this._46_deref_item_smart();
            break;
        case 47:
            result = this._47_deref_item_hash_literal();
            break;
        case 48:
            result = this._48_deref_item_array();
            break;
        case 49:
            result = this._49_deref_item_hash();
            break;
        case 50:
            result = this._50_ws();
            break;
        ...
        case 57:
            ...
            break;
        case 58:
            result = this._58_close();
            break;
        case 59:
            result = this._59_iter_sigil();
            break;
        case 60:
            result = this._60_cond_sigil();
            break;
        case 61:
            result = this._61_call_sigil();
            break;
        case 62:
            result = this._62_decl_sigil();
            break;
        case 63:
            result = this._63_apply_sigil();
            break;
        case 64:
            result = this._64_identifier();
            break;
        case 65:
            result = this._65_ident();
            break;
        case 66:
    ...
    private int _24_sigil_tag_apply() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _27_parameter_name() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _35_single_quote_string() {
        int rep;
        while (true) {
            switch (this.state) {
            case 0:
    ...
    private int _42_parenthesized_expression() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _45_deref_item_method() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _46_deref_item_smart() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _47_deref_item_hash_literal() {
        int rep;
        while (true) {
            switch (this.state) {
            case 0:
    ...
    private int _48_deref_item_array() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _49_deref_item_hash() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
