...
public class MAINBraid extends Cursor<MAINBraid> {
    ...
    public int runRule() {
        ...
        case 21:
            ...
            break;
        case 22:
            result = this._22_sigil_tag_part();
            break;
        case 23:
            result = this._23_sigil_tag_use();
            break;
        case 24:
            result = this._24_sigil_tag_separator();
            break;
        case 25:
            result = this._25_module_name();
            break;
        case 26:
            result = this._26_sigil_tag_apply();
            break;
        case 27:
            result = this._27_signature();
            break;
        case 28:
            result = this._28_parameter();
            break;
        case 29:
            result = this._29_parameter_name();
            break;
        case 30:
            result = this._30_arglist();
            break;
        case 31:
            result = this._31_argument();
            break;
        case 32:
            result = this._32_expression();
            break;
        case 33:
            result = this._33_nextterm();
            break;
        case 34:
        ...
        case 36:
            ...
            break;
        case 37:
            result = this._37_single_quote_string();
            break;
        case 38:
            result = this._38_int();
            break;
        ...
        case 40:
            ...
            break;
        case 41:
            result = this._41_bool();
            break;
        case 42:
            result = this._42_variable();
            break;
        case 43:
            result = this._43_deref_term();
            break;
        case 44:
            result = this._44_parenthesized_expression();
            break;
        case 45:
            result = this._45_deref();
            break;
        case 46:
            result = this._46_deref_item();
            break;
        case 47:
            result = this._47_deref_item_method();
            break;
        case 48:
            result = this._48_deref_item_smart();
            break;
        case 49:
            result = this._49_deref_item_hash_literal();
            break;
        case 50:
            result = this._50_deref_item_array();
            break;
        case 51:
            result = this._51_deref_item_hash();
            break;
        case 52:
            result = this._52_ws();
            break;
        ...
        case 59:
            ...
            break;
        case 60:
            result = this._60_close();
            break;
        case 61:
            result = this._61_iter_sigil();
            break;
        case 62:
            result = this._62_cond_sigil();
            break;
        case 63:
            result = this._63_call_sigil();
            break;
        case 64:
            result = this._64_decl_sigil();
            break;
        case 65:
            result = this._65_apply_sigil();
            break;
        case 66:
            result = this._66_identifier();
            break;
        case 67:
            result = this._67_ident();
            break;
        case 68:
    ...
    private int _22_sigil_tag_part() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _24_sigil_tag_separator() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _26_sigil_tag_apply() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _29_parameter_name() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _37_single_quote_string() {
        int rep;
        while (true) {
            switch (this.state) {
            case 0:
    ...
    private int _44_parenthesized_expression() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _47_deref_item_method() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _48_deref_item_smart() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _49_deref_item_hash_literal() {
        int rep;
        while (true) {
            switch (this.state) {
            case 0:
    ...
    private int _50_deref_item_array() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _51_deref_item_hash() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
