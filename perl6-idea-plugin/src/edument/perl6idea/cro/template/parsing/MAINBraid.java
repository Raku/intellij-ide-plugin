...
public class MAINBraid extends Cursor<MAINBraid> {
    ...
    public int runRule() {
        ...
        case 14:
            ...
            break;
        case 15:
            result = this._15_block();
            break;
        case 16:
            result = this._16_sigil_tag_call();
            break;
        case 17:
            result = this._17_sigil_tag_sub();
            break;
        case 18:
            result = this._18_sigil_tag_macro();
            break;
        case 19:
            result = this._19_sigil_tag_body();
            break;
        case 20:
            result = this._20_sigil_tag_use();
            break;
        case 21:
            result = this._21_sigil_tag_apply();
            break;
        case 22:
            result = this._22_signature();
            break;
        case 23:
            result = this._23_parameter();
            break;
        case 24:
            result = this._24_arglist();
            break;
        case 25:
            result = this._25_expression();
            break;
        case 26:
            result = this._26_nextterm();
            break;
        case 27:
            result = this._27_infixish();
            break;
        case 28:
            result = this._28_infix();
            break;
        case 29:
            result = this._29_term();
            break;
        case 30:
            result = this._30_single_quote_string();
            break;
        case 31:
            result = this._31_int();
            break;
        ...
        case 33:
            ...
            break;
        case 34:
            result = this._34_variable();
            break;
        case 35:
            result = this._35_deref();
            break;
        case 36:
            result = this._36_deref_item();
            break;
        case 37:
            result = this._37_deref_item_smart();
            break;
        case 38:
            result = this._38_ws();
            break;
        ...
        case 45:
            ...
            break;
        case 46:
            result = this._46_close();
            break;
        case 47:
            result = this._47_iter_sigil();
            break;
        case 48:
            result = this._48_cond_sigil();
            break;
        case 49:
            result = this._49_call_sigil();
            break;
        case 50:
            result = this._50_decl_sigil();
            break;
        case 51:
            result = this._51_apply_sigil();
            break;
        case 52:
            result = this._52_identifier();
            break;
        case 53:
            result = this._53_ident();
            break;
        case 54:
    ...
    private int _16_sigil_tag_call() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _18_sigil_tag_macro() {
        int rep;
        while (true) {
            switch (this.state) {
            case 0:
    ...
    private int _19_sigil_tag_body() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _21_sigil_tag_apply() {
        int rep;
        while (true) {
            switch (this.state) {
            case 0:
    ...
    private int _30_single_quote_string() {
        int rep;
        while (true) {
            switch (this.state) {
            case 0:
    ...
    private int _37_deref_item_smart() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
