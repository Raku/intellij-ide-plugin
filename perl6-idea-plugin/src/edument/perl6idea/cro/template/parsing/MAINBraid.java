...
public class MAINBraid extends Cursor<MAINBraid> {
    ...
    public int runRule() {
        ...
        case 25:
            ...
            break;
        case 26:
            result = this._26_parameter_name();
            break;
        case 27:
            result = this._27_arglist();
            break;
        case 28:
            result = this._28_argument();
            break;
        case 29:
            result = this._29_expression();
            break;
        case 30:
            result = this._30_nextterm();
            break;
        case 31:
            result = this._31_infixish();
            break;
        case 32:
            result = this._32_infix();
            break;
        case 33:
            result = this._33_term();
            break;
        case 34:
            result = this._34_single_quote_string();
            break;
        case 35:
            result = this._35_int();
            break;
        ...
        case 37:
            ...
            break;
        case 38:
            result = this._38_bool();
            break;
        case 39:
            result = this._39_variable();
            break;
        case 40:
            result = this._40_deref_term();
            break;
        case 41:
            result = this._41_parenthesized_expression();
            break;
        case 42:
            result = this._42_deref();
            break;
        case 43:
            result = this._43_deref_item();
            break;
        case 44:
            result = this._44_deref_item_method();
            break;
        case 45:
            result = this._45_deref_item_smart();
            break;
        case 46:
            result = this._46_deref_item_hash_literal();
            break;
        case 47:
            result = this._47_deref_item_array();
            break;
        case 48:
            result = this._48_deref_item_hash();
            break;
        case 49:
            result = this._49_ws();
            break;
        ...
        case 56:
            ...
            break;
        case 57:
            result = this._57_close();
            break;
        case 58:
            result = this._58_iter_sigil();
            break;
        case 59:
            result = this._59_cond_sigil();
            break;
        case 60:
            result = this._60_call_sigil();
            break;
        case 61:
            result = this._61_decl_sigil();
            break;
        case 62:
            result = this._62_apply_sigil();
            break;
        case 63:
            result = this._63_identifier();
            break;
        case 64:
            result = this._64_ident();
            break;
        case 65:
    ...
    private int _26_parameter_name() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _34_single_quote_string() {
        int rep;
        while (true) {
            switch (this.state) {
            case 0:
    ...
    private int _41_parenthesized_expression() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _44_deref_item_method() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _45_deref_item_smart() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _46_deref_item_hash_literal() {
        int rep;
        while (true) {
            switch (this.state) {
            case 0:
    ...
    private int _47_deref_item_array() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _48_deref_item_hash() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
