...
public class MAINBraid extends Cursor<MAINBraid> {
    ...
    public int runRule() {
        ...
        case 23:
            ...
            break;
        case 24:
            result = this._24_module_name();
            break;
        case 25:
            result = this._25_sigil_tag_apply();
            break;
        case 26:
            result = this._26_signature();
            break;
        case 27:
            result = this._27_parameter();
            break;
        case 28:
            result = this._28_parameter_name();
            break;
        case 29:
            result = this._29_arglist();
            break;
        case 30:
            result = this._30_argument();
            break;
        case 31:
            result = this._31_expression();
            break;
        case 32:
            result = this._32_nextterm();
            break;
        case 33:
            result = this._33_infixish();
            break;
        case 34:
            result = this._34_infix();
            break;
        case 35:
            result = this._35_term();
            break;
        case 36:
            result = this._36_single_quote_string();
            break;
        case 37:
            result = this._37_int();
            break;
        ...
        case 39:
            ...
            break;
        case 40:
            result = this._40_bool();
            break;
        case 41:
            result = this._41_variable();
            break;
        case 42:
            result = this._42_deref_term();
            break;
        case 43:
            result = this._43_parenthesized_expression();
            break;
        case 44:
            result = this._44_deref();
            break;
        case 45:
            result = this._45_deref_item();
            break;
        case 46:
            result = this._46_deref_item_method();
            break;
        case 47:
            result = this._47_deref_item_smart();
            break;
        case 48:
            result = this._48_deref_item_hash_literal();
            break;
        case 49:
            result = this._49_deref_item_array();
            break;
        case 50:
            result = this._50_deref_item_hash();
            break;
        case 51:
            result = this._51_ws();
            break;
        ...
        case 58:
            ...
            break;
        case 59:
            result = this._59_close();
            break;
        case 60:
            result = this._60_iter_sigil();
            break;
        case 61:
            result = this._61_cond_sigil();
            break;
        case 62:
            result = this._62_call_sigil();
            break;
        case 63:
            result = this._63_decl_sigil();
            break;
        case 64:
            result = this._64_apply_sigil();
            break;
        case 65:
            result = this._65_identifier();
            break;
        case 66:
            result = this._66_ident();
            break;
        case 67:
    ...
    private int _25_sigil_tag_apply() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _28_parameter_name() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _36_single_quote_string() {
        int rep;
        while (true) {
            switch (this.state) {
            case 0:
    ...
    private int _43_parenthesized_expression() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _46_deref_item_method() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _47_deref_item_smart() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _48_deref_item_hash_literal() {
        int rep;
        while (true) {
            switch (this.state) {
            case 0:
    ...
    private int _49_deref_item_array() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
    ...
    private int _50_deref_item_hash() {
        while (true) {
            switch (this.state) {
            case 0:
                this.checkArgs(0);
