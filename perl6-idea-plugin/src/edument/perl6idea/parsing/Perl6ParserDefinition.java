...
public class Perl6ParserDefinition implements ParserDefinition {
    ...
    public PsiElement createElement(ASTNode astNode) {
        ...
        if (type == Perl6ElementTypes.COMMENT)
            return new Perl6CommentImpl(astNode);
      ...
      if (type == Perl6OPPElementTypes.REGEX_INFIX_APPLICATION)
        ...
        if (type == Perl6ElementTypes.POD_PRE_COMMENT)
            return new PodPreCommentImpl(astNode);
        if (type == Perl6ElementTypes.POD_POST_COMMENT)
