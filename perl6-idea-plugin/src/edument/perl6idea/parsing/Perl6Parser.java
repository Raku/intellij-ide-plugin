...
public class Perl6Parser implements PsiParser {
    ...
    private boolean quote_rxlang_137_alt_3(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker quantMarker3;
        quantMarker3 = builder.mark();
    ...
    private boolean quote_rxlang_137_alt_4(PsiBuilder builder, OPP opp) {
        ...
        PsiBuilder.Marker altMarker5;
        altMarker5 = builder.mark();
        if (this.quote_rxlang_137_alt_3(builder, opp)) {
            altMarker5.drop();
        } else {
            altMarker5.rollbackTo();
            PsiBuilder.Marker altMarker2;;
    ...
    private boolean quote_rxlang_137_quant_6(PsiBuilder builder, OPP opp) {
        if (!(this.quotepair_rx_141(builder))) {
            return false;
        }
        if (!(this.ws_260(builder))) {
    ...
    private boolean quote_rxlang_137_alt_7(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker quantMarker8;
        quantMarker8 = builder.mark();
        if (this.quote_rxlang_137_quant_6(builder, opp)) {
            quantMarker8.drop();
        } else {
            quantMarker8.rollbackTo();
            return false;
    ...
    private boolean quote_rxlang_137_alt_8(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        ...
        PsiBuilder.Marker altMarker10;
        altMarker10 = builder.mark();
        if (this.quote_rxlang_137_alt_7(builder, opp)) {
            altMarker10.drop();
        } else {
            altMarker10.rollbackTo();
            PsiBuilder.Marker altMarker7;;
    ...
    private boolean quote_rxlang_137_quant_10(PsiBuilder builder, OPP opp) {
        if (!(this.quotepair_rx_141(builder))) {
            return false;
        }
        if (!(this.ws_260(builder))) {
    ...
    private boolean quote_rxlang_137_alt_11(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker quantMarker13;
        quantMarker13 = builder.mark();
        if (this.quote_rxlang_137_quant_10(builder, opp)) {
            quantMarker13.drop();
        } else {
            quantMarker13.rollbackTo();
            return false;
    ...
    private boolean quote_rxlang_137_alt_12(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
    ...
    private boolean quote_rxlang_137_alt_13(PsiBuilder builder, OPP opp) {
        if (!(this.sibble_168(builder))) {
            return false;
        }
        return true;
    ...
    private boolean quote_rxlang_137_quant_14(PsiBuilder builder, OPP opp) {
        if (!(this.quotepair_rx_141(builder))) {
            return false;
        }
        if (!(this.ws_260(builder))) {
    ...
    private boolean quote_rxlang_137_alt_15(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker quantMarker18;
        quantMarker18 = builder.mark();
        if (this.quote_rxlang_137_quant_14(builder, opp)) {
            quantMarker18.drop();
        } else {
            quantMarker18.rollbackTo();
            return false;
    ...
    private boolean quote_rxlang_137_alt_16(PsiBuilder builder, OPP opp) {
        ...
        if (this.quote_rxlang_137_alt_15(builder, opp)) {
            ...
            PsiBuilder.Marker altMarker17;;
            altMarker17 = builder.mark();
            if (this.quote_rxlang_137_alt_13(builder, opp)) {
                altMarker17.drop();
            } else {
                altMarker17.rollbackTo();
                return false;
    ...
    private boolean quote_rxlang_137_alt_17(PsiBuilder builder, OPP opp) {
        String tt5;
        tt5 = builder.getTokenText();
    ...
    private boolean quote_rxlang_137_alt_18(PsiBuilder builder, OPP opp) {
        String tt6;
        tt6 = builder.getTokenText();
    ...
    private boolean quote_rxlang_137_quant_22(PsiBuilder builder, OPP opp) {
        String tt9;
        tt9 = builder.getTokenText();
    ...
    private boolean quote_rxlang_137_alt_23(PsiBuilder builder, OPP opp) {
        ...
        if (this.quote_rxlang_137_quant_22(builder, opp)) {
            quantMarker27.drop();
        } else {
    ...
    private boolean quote_rxlang_137(PsiBuilder builder) {
        ...
        if (this.quote_rxlang_137_alt_23(builder, opp)) {
            ...
            if (this.quote_rxlang_137_alt_19(builder, opp)) {
                ...
                PsiBuilder.Marker altMarker23;;
                altMarker23 = builder.mark();
                if (this.quote_rxlang_137_alt_18(builder, opp)) {
                    altMarker23.drop();
                } else {
                    altMarker23.rollbackTo();
                    PsiBuilder.Marker altMarker22;;
                    altMarker22 = builder.mark();
                    if (this.quote_rxlang_137_alt_17(builder, opp)) {
                        altMarker22.drop();
                    } else {
                        altMarker22.rollbackTo();
                        PsiBuilder.Marker altMarker21;;
                        ...
                        if (this.quote_rxlang_137_alt_16(builder, opp)) {
                            ...
                            PsiBuilder.Marker altMarker16;;
                            altMarker16 = builder.mark();
                            if (this.quote_rxlang_137_alt_12(builder, opp)) {
                                altMarker16.drop();
                            } else {
                                altMarker16.rollbackTo();
                                PsiBuilder.Marker altMarker11;;
                                altMarker11 = builder.mark();
                                if (this.quote_rxlang_137_alt_8(builder, opp)) {
                                    altMarker11.drop();
                                } else {
                                    altMarker11.rollbackTo();
                                    PsiBuilder.Marker altMarker6;;
