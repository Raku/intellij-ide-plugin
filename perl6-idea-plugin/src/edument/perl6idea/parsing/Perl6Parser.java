...
public class Perl6Parser implements PsiParser {
    ...
    private boolean scope_declarator_162_quant_5(PsiBuilder builder, OPP opp) {
        if (!(this.multi_declarator_76(builder))) {
            return false;
        }
        return true;
    ...
    private boolean scope_declarator_162_alt_6(PsiBuilder builder, OPP opp) {
        ...
        PsiBuilder.Marker quantMarker7;
        quantMarker7 = builder.mark();
        if (this.scope_declarator_162_quant_5(builder, opp)) {
            quantMarker7.drop();
        } else {
            quantMarker7.rollbackTo();
        }
    ...
    private boolean scope_declarator_162_alt_8(PsiBuilder builder, OPP opp) {
        if (!(this.declarator_36(builder))) {
            return false;
        }
        return true;
    ...
    private boolean scope_declarator_162(PsiBuilder builder) {
        ...
        PsiBuilder.Marker altMarker10;
        altMarker10 = builder.mark();
        if (this.scope_declarator_162_alt_8(builder, opp)) {
            altMarker10.drop();
        } else {
            altMarker10.rollbackTo();
            PsiBuilder.Marker altMarker9;;
    ...
    private boolean statement_control_loop_185_quant_12(PsiBuilder builder, OPP opp) {
        if (!(this.block_15(builder))) {
            return false;
        }
        return true;
    ...
    private boolean statement_control_loop_185(PsiBuilder builder) {
        ...
        PsiBuilder.Marker quantMarker13;
        quantMarker13 = builder.mark();
        if (this.statement_control_loop_185_quant_12(builder, opp)) {
            quantMarker13.drop();
        } else {
            quantMarker13.rollbackTo();
        }
    ...
    private boolean statement_control_need_186_quant_3(PsiBuilder builder, OPP opp) {
        if (!(this.ws_258(builder))) {
            return false;
        }
        return true;
    ...
    private boolean statement_control_need_186_alt_5(PsiBuilder builder, OPP opp) {
        if (!(this.version_255(builder))) {
            return false;
        }
        return true;
    ...
    private boolean statement_control_need_186_quant_6(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker altMarker6;
        altMarker6 = builder.mark();
        if (this.statement_control_need_186_alt_5(builder, opp)) {
            altMarker6.drop();
        } else {
            altMarker6.rollbackTo();
            PsiBuilder.Marker altMarker5;;
    ...
    private boolean statement_control_need_186_quant_9(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker quantMarker4;
        quantMarker4 = builder.mark();
        if (this.statement_control_need_186_quant_3(builder, opp)) {
            quantMarker4.drop();
        } else {
            quantMarker4.rollbackTo();
        }
    ...
    private boolean statement_control_need_186_quant_10(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker altMarker3;
        altMarker3 = builder.mark();
    ...
    private boolean statement_control_need_186(PsiBuilder builder) {
        ...
        PsiBuilder.Marker quantMarker11;
        quantMarker11 = builder.mark();
        if (this.statement_control_need_186_quant_10(builder, opp)) {
            quantMarker11.drop();
        } else {
            quantMarker11.rollbackTo();
        }
    ...
    private boolean statementlist_217_quant_1(PsiBuilder builder, OPP opp) {
    ...
    private boolean statementlist_217_alt_3(PsiBuilder builder, OPP opp) {
        if (!(this.ws_258(builder))) {
            return false;
        }
        return true;
    ...
    private boolean statementlist_217_quant_5(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker marker5;
        marker5 = builder.mark();
        if (!(this.statement_175(builder))) {
            return false;
    ...
    private boolean statementlist_217(PsiBuilder builder) {
        ...
        PsiBuilder.Marker quantMarker1;
        quantMarker1 = builder.mark();
        if (this.statementlist_217_quant_1(builder, opp)) {
            quantMarker1.drop();
        } else {
            quantMarker1.rollbackTo();
        }
        ...
        PsiBuilder.Marker altMarker4;
        altMarker4 = builder.mark();
        if (this.statementlist_217_alt_3(builder, opp)) {
            altMarker4.drop();
        } else {
            altMarker4.rollbackTo();
            PsiBuilder.Marker altMarker3;;
        ...
        while (true) {
            PsiBuilder.Marker quantMarker7;;
            quantMarker7 = builder.mark();
            if (this.statementlist_217_quant_5(builder, opp)) {
                quantMarker7.drop();
            } else {
                quantMarker7.rollbackTo();
                break;
