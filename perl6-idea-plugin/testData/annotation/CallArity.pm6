...
a(<error descr="Not enough positional arguments">42</error>);
a(42, 42);
a(24, 24, <error descr="Too many positional arguments">24</error>);
a(42, 42, <error descr="No such named parameter in signature">test => 555</error>);

sub b($a, *%h) { $a; %h }

b(42);
b(42, <error descr="Too many positional arguments">42</error>);
b(42, a => 42, b => 42);

sub c($a, $b, *@p) { $a; $b; @p;}

c(<error descr="Not enough positional arguments">42</error>);
c(42, 42);
c(42, 42, 42, 42, 42);
...
d(<error descr="Not enough positional arguments">42</error>);
d(42, 42);
d(42, 42, 42, 42);
...
class A {
    ...
    method b($int, :$a, :$b!) {
        if $int + $a + $b == 42 {
            ...
            self.a(3, not-used => 'value') + self.m(<error descr="Not enough positional arguments">42</error>);
        }
    }
    method d {}
}
...
e(b => 42);
e(<error descr="This call misses a required named argument: $b">555</error>);
